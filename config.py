...
class Config(object):
    ...
    ACTION_EXPORTER_HOST = os.getenv('ACTION_EXPORTER_SERVICE_HOST', 'localhost')
    ACTION_EXPORTER_PORT = os.getenv('ACTION_EXPORTER_SERVICE_PORT', 8141)
    ...
    RESPONSE_OPERATIONS_UI_HOST = os.getenv('RESPONSE_OPERATIONS_UI_SERVICE_HOST', 'localhost')
    RESPONSE_OPERATIONS_UI_PORT = os.getenv('RESPONSE_OPERATIONS_UI_SERVICE_PORT', 8085)
    ...
    RESPONDENT_HOME_UI_HOST = os.getenv('RESPONDENT_HOME_UI_SERVICE_HOST', 'localhost')
    RESPONDENT_HOME_UI_PORT = os.getenv('RESPONDENT_HOME_UI_SERVICE_PORT', 9092)
