-- Add the classifier for Bricks (survey_id cb8accda-6118-4d3b-85a3-149e28960c54)
...
-- Add the classifier for Blocks (survey_id 9b6872eb-28ee-4c09-b705-c3ab1bb0f9ec)
insert into survey.classifierType( classifiertypepk,classifiertypeselectorfk,classifiertype)
values(5,15,'COLLECTION_EXERCISE');
-- Add the action plans for Bricks cb8accda (074) and Blocks 9b6872eb (073)
...
-- Add actionplan links for Bricks
...
-- Add actionplan links for Blocks
insert into collectionexercise.casetypedefault(casetypedefaultpk, sampleunittypefk, actionplanid, survey_uuid)
...
-- Set the CE dates for 074 Bricks period 201801
